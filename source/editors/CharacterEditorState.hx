...
class CharacterEditorState extends MusicBeatState
{
	...
	function reloadBGs() {
		...
		if(onPixelBG) {
			...
			var bg:BGSprite = new BGSprite('bg/stageback', -600 + OFFSET_X - playerXDifference, -800, 0.95, 0.95);
			bgLayer.add(bg);

			var stageFront:BGSprite = new BGSprite('bg/stagefront', -650 + OFFSET_X - playerXDifference, 500, 0.9, 0.9);
